...
file_path=$project_path/tools/load_room.py           # system path to loading function
...
data_path=/d/Gibson/3DSceneGraph_medium/data                    # system path to 3D Scene Graph results
palette_path=$project_path/tools/palette.txt    # system path to color palette (for visualization purposes)
gibson_mesh_path=/d/Gibson/gibson_medium       # system path to Gibson database model data
...
dump_models="${tiny_models} ${medium_models}"
